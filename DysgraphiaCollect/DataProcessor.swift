...
class DataProcessor {
    ...
    /// Chuyển đổi PKStroke thành HandwritingStroke kèm theo các chỉ số tính toán
    static func process(pkStroke: PKStroke) -> HandwritingStroke {
